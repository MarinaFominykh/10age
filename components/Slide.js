...
export class Slide {
  ...
  getSlide = () => {
    ...
    this._slideContainer = this._slideElement.querySelector('.presents__present');
    ...
    this._slideContainer.style.cssText = 'background-image: url(../images/presents/' + this._src + '.png);'
